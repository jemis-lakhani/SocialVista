...
function Navbar() {
  ...
  const isNonMobileScreens = useMediaQuery("(min-width: 1000px)"); // to determine min screen width
...
// clamp - adjust fontsize according to screensize
// sx - to pass psuedo css properties
